...
"""
# insert before `const handleSendOTP = async () => {`
if 'const [summaryFile, setSummaryFile]' not in content:
    content = content.replace("const handleSendOTP = async () => {", states_injection + "\n  const handleSendOTP = async () => {")

# Add resetApp additions
...
if 'Doc Summarizer' not in content:
...
"""
if "activeTab === 'summarizer'" not in content:
    content = content.replace("          {activeTab === 'rights' && (", left_view + "          {activeTab === 'rights' && (")
...
"""
if "{summaryState === 'result'" not in content:
    content = content.replace("          {activeTab === 'rights' && (", right_view + "          {activeTab === 'rights' && (")
